...
export const EXPERIENCES = [
  {
    ...
    company: "Redsis",
    description: `Automated migration of 1,600+ processes to JAMS for a financial institution, improved scalability, eliminated legacy errors. Developed a Python ETL for SQL Server data integration with REST APIs. Implemented PowerShell automation to validate system resources. Integrated business-specific logic with JAMS and led stakeholder meetings.`,
  ...
  },
  {
    ...
    company: "WebCoop",
    description: `Developed backend treasury module using Laravel and MySQL. Implemented frontend with Blade and JavaScript. Collaborated with banking cooperatives to gather requirements. Added WhatsApp API integration for automated reports.`,
  ...
  },
  {
    ...
    company: "Hausi",
    description: `Built a loan calculator and mobile app for property rental/sales using Flask and Firebase. Integrated authentication, property search, and state management. Automated CRM data imports with Make.`,
  ...
  },
  {
    ...
    role: "Full Stack Web Developer",
    company: "Marcairis",
    description: `Developed Angular frontend and Firebase backend. Enabled multi-method authentication and user roles. Built social interaction features and Laravel APIs for metadata generation and reporting. Migrated project to Ionic for multi-platform support.`,
    technologies: [
      "Angular",
      "TypeScript",
      "Firebase",
